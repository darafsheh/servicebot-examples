...
const SeatPortalPage = () => {
    const [step1, setStep1] = useState(true);
    const [step2, setStep2] = useState(false);
    const [step3, setStep3] = useState(false);
    const [step4, setStep4] = useState(false);
    const [billingPage, setBillingPage] = useState({billing_page_id:'eiA6aUHX1wBjrUVYp97e', "email":"clockwork@yopmail.com"});
  ...
  return (
    <Layout title="Standard Customer Portal" location={location.search}>
      <SEO
        title="SaaS Per Seat Customer Portal Live Example"
        description="Live example of per seat customer portal with Stripe and Billflow"
