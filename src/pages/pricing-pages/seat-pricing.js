...
const SeatPricingPage = () => {
    ...
    const [billingPage, setBillingPage] = useState({billing_page_id:'VL0RAEWCI21QJ8HuTQvK'});
  ...
  return (
    <Layout title="Standard Pricing Page" location={location.search}>
      <SEO
        title="SaaS Per Seat Pricing Page"
        description="Live example of SaaS per seat pricing pages with Stripe and Billflow"
                ...
                <>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                        ...
                        <div>
                            ...
                            Per Seat pricing examples
                            </h1>
                            <span className="text-green-600">Select a plan, select number of seats, and test with a Stripe test credit card.</span>
                        </div>
                        </header>
                        <main>
