...
const StandardPricingPage = () => {
    ...
    const [billingPage, setBillingPage] = useState({billing_page_id:'ajnykTNIsZCc0JmqT4NF'});
  ...
  return (
    <Layout title="Peloton Pricing Page Example" location={location.search}>
      <SEO
        title="Peloton Pricing Page"
        description="Live example of Peloton pricing with Stripe and Billflow"
