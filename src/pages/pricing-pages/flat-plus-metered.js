...
const FlatMeteredPricing = () => {
    const [step1, setStep1] = useState(true);
    const [step2, setStep2] = useState(false);
    const [step3, setStep3] = useState(false);
    const [step4, setStep4] = useState(false);
    const [billingPage, setBillingPage] = useState({billing_page_id:'cwsbuQwJOyhQJcJgQp3a'});
  ...
  return (
    <Layout title="Peloton Pricing Page Example" location={location.search}>
      <SEO
        title="Flat plus Metered Pricing Page"
        description="Live example of flat plus metered pricing with Stripe and Billflow"
                ...
                <>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                        ...
                        <div>
                            ...
                            Live flat plus metered pricing examples
                            </h1>
...
export default FlatMeteredPricing
