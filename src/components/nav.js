          ...
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 px-2 bg-white space-y-1">  
                ...
                <div className="space-y-1">
                    ...
                    <div className={`${pricingPages ? '' : 'hidden'} space-y-1`}>
                      <Link to="/pricing-pages/flat-plus-metered" activeClassName="bg-gray-100 text-gray-900" className="group w-full flex items-center pl-11 pr-2 py-2 text-sm font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50">
                      <span class="w-2.5 h-2.5 mr-4 bg-green-500 rounded-full" aria-hidden="true"></span>
                      <span class="truncate">
                    ...
                    <div className={`${pricingPages ? '' : 'hidden'} space-y-1`}>
                      <Link to="/pricing-pages/multi-unit-pricing" activeClassName="bg-gray-100 text-gray-900" className="group w-full flex items-center pl-11 pr-2 py-2 text-sm font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50">
                      <span class="w-2.5 h-2.5 mr-4 bg-green-500 rounded-full" aria-hidden="true"></span>
                      <span class="truncate">
                          Multi-Unit Pricing
                      </span>
